    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <?php 
                if(isset($Units)){
                    $language = lang('edit_multiple_currency');
                }else{
                    $language = lang('add_multiple_currency');
                }
                ?>
                <h3 class="top-left-header mt-2"><?php echo $language ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('setting'), 'secondSection'=> $language])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        <div class="table-box">
            ...
            <div class="box-footer">
                ...
                <a class="btn bg-blue-btn text-decoration-none" href="<?php echo base_url() ?>MultipleCurrency/multipleCurrencies">
