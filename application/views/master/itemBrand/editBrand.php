...
<?php
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('edit_brand'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('brand'), 'secondSection'=> lang('edit_brand')])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        <div class="table-box">  
            <!-- form start -->
            <?php echo form_open(base_url('Brand/addEditBrand/' . $encrypted_id)); ?>
            <div class="box-body">
                <div class="row">
