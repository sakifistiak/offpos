...
<h3 class="display_none">&nbsp;</h3>
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header"><?php echo lang('item_barcode'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('item'), 'secondSection'=> lang('item_barcode')])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        <div class="table-box">
            <?php echo form_open(base_url() . 'Item/itemBarcodeGenerator', $arrayName = array('id' => 'productBarcodeGenerator', 'enctype' => 'multipart/form-data')) ?>
            <div class="table-box">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex">
                                        <div>
                                            <label
                                                class="container"><?php echo lang('select'); ?>
                                                <input type="checkbox" class="checkbox_user form-control"
                                                data-menu_id="<?php echo escape_output($ingrnts->id); ?>"
                                                value="<?= $ingrnts->id . "|" . $ingrnts->name . "|" . $ingrnts->code . "|" . $ingrnts->sale_price . "|" . $ingrnts->parent_id ?>"
                                                name="item_id[]">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="form-group">
                                            <input class="op_center"
                                                disabled type="number" min="1"
                                                id="qty<?php echo escape_output($ingrnts->id); ?>" name="qty[]"
                                                value="">
                                        </div>
                                    </div>  
                                </td>
...
<script src="<?php echo base_url(); ?>frequent_changing/js/product-barcode.js"></script>
