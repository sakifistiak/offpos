                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 mb-3 disable_service_field" id="profit_margin">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input name="profit_margin" onfocus="this.select();" type="text" class="form-control integerchk disable_service" id="profit_margin_val" placeholder="<?php echo lang('profit_margin'); ?>" aria-label="<?php echo lang('profit_margin'); ?>" aria-describedby="basic-addon2" value="<?php echo $item_details->profit_margin; ?>">
                    ...
                    <div class="item_append">
                        ...
                        <?php } }else{
                            foreach($stockDetails as $stok_d){ ?>
                                ...
                                <input type="hidden" name="quantity[]" value="<?php echo (float)$stok_d->stock_quantity / (float)$item_details->conversion_rate; ?>">
