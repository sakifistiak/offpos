...
?> 
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header"><?php echo lang('debit_suppliers'); ?> </h3>
                <input type="hidden" class="datatable_name" data-title="<?php echo lang('debit_suppliers'); ?>" data-id_name="datatable">
            ...
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('supplier'), 'secondSection'=> lang('debit_suppliers')])?>
        </div>
    </section>
                    ...
                    <table id="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="w-15 text-center"><?php echo lang('Current_Debit_Amount'); ?></th>
                        ...
                        <tbody>
                            ...
                            if ($debit_suppliers && !empty($debit_suppliers)) {
                                $i = count($debit_suppliers);
                            }
                            foreach ($debit_suppliers as $si) {
