...
<h3 class="display_none">&nbsp;</h3>
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header"><?php echo lang('list_denominations'); ?> </h3>
                <input type="hidden" class="datatable_name" data-title="<?php echo lang('list_denominations'); ?>" data-id_name="datatable">
                <div class="btn_list m-right d-flex">
                    <a class="new-btn me-1" href="<?php echo base_url() ?>Denomination/addEditDenomination">
                    <iconify-icon icon="solar:add-circle-broken" width="22"></iconify-icon> <?php echo lang('add_denomination'); ?>
                    </a>
                </div>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('denominations'), 'secondSection'=> lang('list_denominations')])?>
        </div>
    </section>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn_group_wrap">
                                    ...
                                    <a class="delete btn btn-danger" href="<?php echo base_url() ?>denomination/deleteDenomination/<?php echo escape_output($this->custom->encrypt_decrypt($value->id, 'encrypt')); ?>" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="<?php echo lang('delete'); ?>">
