...
<?php
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('edit_rack'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('rack'), 'secondSection'=> lang('edit_rack')])?>
        </div>
    </section>
    ...
    <h3 class="display_none">&nbsp;</h3>
        <div class="table-box">  
            <!-- form start -->
            <?php echo form_open(base_url('Rack/addEditRack/' . $encrypted_id)); ?>
            <div class="box-body">
                <div class="row">
            ...
            <div class="box-footer">
                ...
                <a class="btn bg-blue-btn text-decoration-none" href="<?php echo base_url() ?>Rack/rackList">
