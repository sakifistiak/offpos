...
<?php
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('add_fixed_asset_item'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('fixed_asset_item'), 'secondSection'=> lang('add_fixed_asset_item')])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        <div class="table-box">  
            <!-- form start -->
            <?php echo form_open(base_url('Fixed_assets/addEditItem')); ?>
            <div class="box-body">
                <div class="row">
