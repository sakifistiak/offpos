                            ...
                            <div class="d-flex">
                                <div class="op_webkit_fill_available"> 
                                    <select name="printer_id" class="select2 form-control" id="counter_printer_id">
                                        ...
                                        ?>
                                        <option <?php echo $counter->printer_id == $printer->id ? 'selected' : '' ?> <?php echo set_select('printer_id', $printer->id);?> value="<?php echo escape_output($printer->id) ?>"><?php echo escape_output($printer->title) ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
