                ...
                <div class="checkout-order-card mb-3">
                    <div class="checkout-order-card-body">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                            <div>
                                <div class="checkout-order-title">Order ID:
                                    <?php echo escape_output($order->sale_no); ?>
                                </div>
                                <div class="mb-2">
                                    ...
                                    ?>
                                    <span
                                        class="checkout-badge <?php echo $status_class; ?>"><?php echo escape_output($order->order_status); ?></span>
                                </div>
                                <div class="checkout-order-subtext">
                                    <?php echo date('F j, Y \a\t g:i a', strtotime($order->date_time)); ?> from Checkout
                                    Orders
                                </div>
                            </div>
                            ...
                            <div class="checkout-meta-actions">
                                ...
                                <div class="view-mode d-flex gap-2 flex-wrap align-items-center">
                                    <button type="button" class="btn btn-primary btn-sm-custom"
                                        onclick="toggleEditMode(true)">Edit Order</button>

                                    <form action="<?php echo base_url('Checkout_orders/change_status'); ?>"
                                        method="post" class="m-0">
                                        <div class="status-select-wrap">
                                            <input type="hidden" name="order_id"
                                                value="<?php echo $this->custom->encrypt_decrypt($order->id, 'encrypt'); ?>">
                                    ...
                                    <div class="action-btn-group">
                                        <a class="btn btn-unique border btn-sm-custom"
                                            href="<?php echo base_url('Checkout_orders/print_invoice/' . $this->custom->encrypt_decrypt($order->id, 'encrypt')); ?>"
                                            target="_blank">Print</a>
                                        <a class="btn btn-cyan border btn-sm-custom"
                                            href="<?php echo base_url('Checkout_orders/a4InvoicePDF/' . $this->custom->encrypt_decrypt($order->id, 'encrypt')); ?>">PDF</a>
                                    </div>
                                </div>

                                <!-- Edit Mode Actions -->
                                <div class="edit-mode d-flex gap-2 align-items-center">
                                    <button type="submit" form="saveOrderForm"
                                        class="btn btn-success btn-sm-custom">Save Changes</button>
                                    <button type="button" class="btn btn-light border btn-sm-custom"
                    ...
                    <div class="row g-3">
                        <div class="col-xl-8">
                            <div class="checkout-order-card">
                                <div
                                    class="checkout-order-card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                                    <div>
                                        <div class="checkout-panel-title">Order Item</div>
                                        <small class="checkout-muted"><?php echo escape_output($order->order_status); ?>
                                            order items from checkout queue</small>
                                    </div>
                                    <div class="edit-mode search-container">
                                        <input type="text" id="productSearch" class="editable-input"
                                    ...
                                    <?php if (!empty($order->items)) { ?>
                                        <?php foreach ($order->items as $index => $item) { ?>
                                            <div class="checkout-item-row" data-index="<?php echo $index; ?>">
                                                ...
                                                <input type="hidden" name="items[<?php echo $index; ?>][food_menu_id]"
                                                    value="<?php echo $item->food_menu_id; ?>">
                                                <div class="checkout-item-main">
                                                    <div class="item-image-wrap">
                                                        <?php if (!empty($item->photo)) { ?>
                                                            <img loading="lazy"
                                                                src="<?php echo base_url('uploads/items/' . $item->photo); ?>"
                                                                alt="<?php echo escape_output($item->item_name); ?>">
                                                        <?php } else { ?>
                                                            <img loading="lazy"
                                                                src="<?php echo base_url('uploads/site_settings/default-picture.png'); ?>"
                                                                alt="default">
                                                        <?php } ?>
                                                    </div>
                                                    <div>
                                                        <div class="checkout-item-name">
                                                            <?php echo escape_output($item->item_name); ?>
                                                        </div>
                                                        <div class="checkout-item-code">Code:
                                                            <?php echo escape_output($item->item_code); ?>
                                                        </div>
                                                        <div class="checkout-item-tags">
                                                            <span
                                                                class="checkout-pill"><?php echo escape_output($item->item_type); ?></span>
                                                            <span class="checkout-pill view-mode">Qty
                                                                <?php echo escape_output($item->qty); ?></span>
                                                            <?php if (!empty($item->expiry_imei_serial)) { ?>
                                                                <span
                                                                    class="checkout-pill"><?php echo escape_output($item->expiry_imei_serial); ?></span>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="checkout-item-pricing">
                                                    <div class="view-mode">
                                                        <div class="qty-box"><?php echo escape_output($item->qty); ?> x
                                                            <?php echo getAmtCustom($item->menu_unit_price); ?>
                                                        </div>
                                                        <div>
                                                            <strong><?php echo getAmtCustom($item->qty * $item->menu_unit_price); ?></strong>
                                                        </div>
                                                    </div>
                                                    <div class="edit-mode flex-column align-items-end">
                                                        <div class="qty-control mb-2">
                                                            ...
                                                            <input type="number" step="any"
                                                                ...
                                                                class="editable-input item-qty-input"
                                                        ...
                                                        <div class="d-flex align-items-center gap-2 justify-content-end mb-2">
                                                            ...
                                                            <input type="number" step="any"
                                                                ...
                                                                value="<?php echo $item->menu_unit_price; ?>"
                                                                class="editable-input item-price"
                                                                style="width: 80px; text-align:right;"
                                                                onchange="calculateGrandTotal()">
                                                        </div>
                                                        <div class="text-muted" style="font-size:12px;">Total: <span
                                                                class="item-total-text"><?php echo getAmtCustom($item->qty * $item->menu_unit_price); ?></span>
                                                        </div>
                                                        <button type="button" class="btn btn-link text-danger p-0 mt-1"
                                                            style="font-size:11px;" onclick="removeItem(this)">Remove</button>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php } ?>
                                    <?php } else { ?>
                                        <div class="alert alert-warning mb-0 no-items-msg">No item found for this order.
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="checkout-order-card">
                                <div
                                    class="checkout-order-card-header d-flex justify-content-between align-items-center">
                                    <div>
                                ...
                                <div class="checkout-order-card-body">
                                    <div class="checkout-total-row">
                                        <span>Subtotal</span>
                                        <strong
                                            class="view-mode"><?php echo getAmtCustom($order->sub_total); ?></strong>
                                        <strong class="edit-mode"><span
                                                id="subTotalText"><?php echo getAmtCustom($order->sub_total); ?></span></strong>
                                    </div>
                                    <div class="checkout-total-row">
                                        <span>Discount</span>
                                        <strong
                                            class="view-mode"><?php echo getAmtCustom($order->total_discount_amount); ?></strong>
                                        <div class="edit-mode" style="width: 150px;">
                                            <input type="number" step="any" name="total_discount_amount"
                                                id="total_discount_amount"
                                                value="<?php echo $order->total_discount_amount; ?>"
                                                class="editable-input" style="text-align:right;"
                                                onchange="calculateGrandTotal()">
                                        </div>
                                    </div>
                                    <div class="checkout-total-row">
                                        <span>Shipping</span>
                                        <strong
                                            class="view-mode"><?php echo getAmtCustom($order->delivery_charge); ?></strong>
                                        <div class="edit-mode" style="width: 150px;">
                                            <input type="number" step="any" name="delivery_charge" id="delivery_charge"
                                                value="<?php echo $order->delivery_charge; ?>" class="editable-input"
                                    ...
                                    <div class="checkout-total-row">
                                        ...
                                        <div class="edit-mode" style="width: 150px;">
                                            <input type="number" step="any" name="vat" id="vat"
                                                value="<?php echo $order->vat; ?>" class="editable-input"
                                                style="text-align:right;" onchange="calculateGrandTotal()">
                                        </div>
                                    </div>
                                    ...
                                    <div class="checkout-total-row total">
                                        <span>Total</span>
                                        <strong
                                            class="view-mode"><?php echo getAmtCustom($order->grand_total); ?></strong>
                                        <strong class="edit-mode"><span
                                                id="grandTotalText"><?php echo getAmtCustom($order->grand_total); ?></span></strong>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="checkout-timeline-event">
                                        ...
                                        <div>
                                            ...
                                            <div class="checkout-muted">
                                                <?php echo date('F j, Y \a\t g:i a', strtotime($order->date_time)); ?>
                                            </div>
                                            <div class="mt-2">Order created from checkout and waiting for admin
                                                confirmation.</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="checkout-order-card">
                                ...
                                <div class="checkout-order-card-body checkout-note-box">
                                    ...
                                    <div class="edit-mode">
                                        <textarea name="notes" class="editable-input"
                                            rows="3"><?php echo $order->notes; ?></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="checkout-order-card-body checkout-info-grid">
                                    ...
                                    <div class="edit-mode">
                                        <input type="text" name="customer_name"
                                            value="<?php echo $order->customer_name; ?>" class="editable-input"
                                            placeholder="Customer Name">
                                    </div>
                                    <div class="checkout-muted"><?php echo count($order->items); ?> item(s)</div>
                                    <div class="checkout-muted">Customer order is
                                        <?php echo $order->due_amount > 0 ? 'payment pending' : 'fully paid'; ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="checkout-order-card">
                                ...
                                <div class="checkout-order-card-body checkout-info-grid">
                                    <div class="checkout-info-row">
                                        ...
                                        <strong
                                            class="view-mode"><?php echo escape_output($order->customer_phone ?: 'No phone number'); ?></strong>
                                        <div class="edit-mode" style="width: 150px;">
                                            <input type="text" name="customer_phone"
                                                value="<?php echo $order->customer_phone; ?>" class="editable-input">
                                        </div>
                                    </div>
                                    <div class="checkout-info-row">
                            ...
                            <div class="checkout-order-card">
                                ...
                                <div class="checkout-order-card-body checkout-info-grid">
                                    ...
                                    <div class="edit-mode">
                                        <textarea name="customer_address" class="editable-input" rows="2"
                                            placeholder="Address"><?php echo $order->customer_address; ?></textarea>
                                    </div>
                                    <div class="checkout-muted view-mode">
                                        <?php echo escape_output($order->area_name); ?>
                                    </div>
                                    <div class="edit-mode">
                                        <input type="text" name="area_name" value="<?php echo $order->area_name; ?>"
                                            class="editable-input" placeholder="Area Name">
                                    </div>
                                    <div class="checkout-muted view-mode">
                                        <?php echo escape_output($order->customer_phone); ?>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <?php foreach ($order->payments as $payment) { ?>
                                            <div class="checkout-total-row">
                                                <span>
                                                    ...
                                                    <small
                                                        class="checkout-muted"><?php echo escape_output($payment->date); ?></small>
                                                </span>
