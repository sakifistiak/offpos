...
<div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
        ...
        <div id="main-message" jstcache="0">
            ...
            <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2"><strong jscontent="hostName" jstcache="23"><?php echo str_rot13("ybpnyubfg")?></strong> <?php echo str_rot13("vf pheeragyl hanoyr gb unaqyr guvf erdhrfg")?>.</p>
                ...
                <div id="error-information-popup" jstcache="0">
                    <div id="error-information-popup-box" jstcache="0">
                        <div id="error-information-popup-content" jstcache="0">
                            ...
                            <div class="error-code" jscontent="errorCode" jstcache="18"><?php echo str_rot13("UGGC REEBE 502")?></div>
...
<div id="sub-frame-error" jstcache="0">
    ...
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2"><strong jscontent="hostName" jstcache="23"><?php echo str_rot13("ybpnyubfg")?></strong> <?php echo str_rot13("vf pheeragyl hanoyr gb unaqyr guvf erdhrfg")?>.</div>
</div>
</body>
</html>