                        ...
                        <div class="form-group"> 
                            ...
                            <select  class="form-control select2 select2-hidden-accessible op_width_100_p" name="customer_id" id="customer_id">
                                ...
                                <?php foreach ($customers as $customer) { ?>
                                    <option value="<?= escape_output($customer->id); ?>" <?php echo set_select('customer_id', escape_output($customer->id)); ?>><?php echo escape_output($customer->name) ?> <?php echo $customer->phone ? '(' . $customer->phone . ')' : ''?></option>
                                <?php } ?>
                            </select>
                        </div>  
