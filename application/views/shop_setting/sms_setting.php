<script src="<?php echo base_url('frequent_changing/js/sms_setting_update.js'); ?>"></script>
<!-- Main content -->
...
<h3 class="display_none"></h3>
    ...
    <div class="box-wrapper">
        <div class="table-box">
            <?php
                $active_provider = isset($sms_information->sms_service_provider) ? (string) $sms_information->sms_service_provider : '';
                $sms_info = isset($sms_information->sms_details) && $sms_information->sms_details ? json_decode($sms_information->sms_details) : '';
                $status_templates = [];
                if (isset($sms_information->sms_details) && $sms_information->sms_details) {
                    $details_array = json_decode($sms_information->sms_details, true);
                    if (!empty($details_array['status_templates']) && is_array($details_array['status_templates'])) {
                        $status_templates = $details_array['status_templates'];
                    }
                }
                if (empty($status_templates)) {
                    foreach ($sms_status_options as $code => $label) {
                        $status_templates[$code] = ['enabled' => 0, 'message' => ''];
                    }
                }
            ?>
            <?php echo form_open(base_url('Short_message_service/SMSSetting')); ?>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label><?php echo lang('sms_service_provider')?> <span class="required_star">*</span><small class="show_text"></small></label>
                            <select name="sms_service_provider"  class="form-control select2 sms_service_provider" data-initial="<?php echo escape_output($active_provider); ?>">
                                ...
                                <option <?php echo set_select('sms_service_provider',"3")?>  <?=(isset($sms_information->sms_service_provider) && $sms_information->sms_service_provider && $sms_information->sms_service_provider=="3"?'selected':'')?> value="3" data-text_singup="<?php echo lang('gotothisurlforsignupaccount')?>" data-signup_url="<?php echo getSMSSignupUrl(3)?>"><?php echo lang('mim_sms')?></option>

                                <option <?php echo set_select('sms_service_provider',"4")?>  <?=(isset($sms_information->sms_service_provider) && $sms_information->sms_service_provider && $sms_information->sms_service_provider=="4"?'selected':'')?> value="4" data-text_singup="<?php echo lang('gotothisurlforsignupaccount')?>" data-signup_url="<?php echo getSMSSignupUrl(4)?>"><?php echo lang('text_local')?></option>
                                <option <?php echo set_select('sms_service_provider',"5")?>  <?=(isset($sms_information->sms_service_provider) && $sms_information->sms_service_provider && $sms_information->sms_service_provider=="5"?'selected':'')?> value="5" data-text_singup="" data-signup_url="">Ecare SMS</option>
                ...
                <div  class="row div_hide div_1" data-provider="1" style="<?php echo $active_provider === '1' ? '' : 'display:none;'; ?>">
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            <label><?php echo lang('SID'); ?> <span class="required_star">*</span></label>
                            <input type="text" name="field_1_0" value="<?=(isset($sms_info->field_1_0) && $sms_info->field_1_0 ? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_1_0) :set_value('field_1_0'))?>" onfocus="select();" placeholder="<?php echo lang('SID'); ?>" id="field_1_0" class="form-control">
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="field_1_1" value="<?=(isset($sms_info->field_1_1) && $sms_info->field_1_1? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_1_1) : set_value('field_1_1'))?>" onfocus="select();" placeholder="<?php echo lang('Token'); ?>" id="field_1_1" class="form-control">
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="field_1_2" value="<?=(isset($sms_info->field_1_2) && $sms_info->field_1_2 ? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_1_2) : set_value('field_1_2'))?>" onfocus="select();" placeholder="<?php echo lang('Twilio_Number'); ?>" id="field_1_2" class="form-control">
                        </div>
                ...
                <div  class="row div_hide div_2" data-provider="2" style="<?php echo $active_provider === '2' ? '' : 'display:none;'; ?>">
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            <label><?php echo lang('profile_id'); ?> <span class="required_star">*</span></label>
                            <input type="text" name="field_2_0" value="<?=(isset($sms_info->field_2_0) && $sms_info->field_2_0 ? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_2_0) : set_value('field_2_0'))?>" onfocus="select();" placeholder="<?php echo lang('profile_id'); ?>" id="field_2_0" class="form-control">
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="field_2_1" value="<?=(isset($sms_info->field_2_1) && $sms_info->field_2_1 ? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_2_1) :set_value('field_2_1'))?>" onfocus="select();" placeholder="<?php echo lang('password'); ?>" id="field_2_1" class="form-control">
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="field_2_2" value="<?=(isset($sms_info->field_2_2) && $sms_info->field_2_2 ? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_2_2) : set_value('field_2_2'))?>" onfocus="select();" placeholder="<?php echo lang('sender_id'); ?>" id="field_2_2" class="form-control">
                        </div>
                ...
                <div  class="row div_hide div_3" data-provider="3" style="<?php echo $active_provider === '3' ? '' : 'display:none;'; ?>">
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            <label><?php echo lang('api_key'); ?> <span class="required_star">*</span></label>
                            <input type="text" name="field_3_1" value="<?=(isset($sms_info->field_3_1) && $sms_info->field_3_1? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_3_1) : set_value('field_3_1'))?>" onfocus="select();" placeholder="<?php echo lang('api_key'); ?>" id="field_3_1" class="form-control">
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            <label><?php echo lang('sender_id'); ?> <span class="required_star">*</span></label>
                            <input type="text" name="field_3_2" value="<?=(isset($sms_info->field_3_2) && $sms_info->field_3_2 ? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_3_2) : set_value('field_3_2'))?>" onfocus="select();" placeholder="<?php echo lang('sender_id'); ?>" id="field_3_2" class="form-control">
                        </div>
                ...
                <div  class="row div_hide div_4" data-provider="4" style="<?php echo $active_provider === '4' ? '' : 'display:none;'; ?>">
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            <label><?php echo lang('profile_id'); ?> <span class="required_star">*</span></label>
                            <input type="text" name="field_4_0" value="<?=(isset($sms_info->field_4_0) && $sms_info->field_4_0 ? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_4_0) : set_value('field_4_0'))?>" onfocus="select();" placeholder="<?php echo lang('profile_id'); ?>" id="field_4_0" class="form-control">
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            <label><?php echo lang('api_key'); ?> <span class="required_star">*</span></label>
                            <input type="text" name="field_4_1" value="<?=(isset($sms_info->field_4_1) && $sms_info->field_4_1 ? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_4_1) : set_value('field_4_1'))?>" onfocus="select();" placeholder="<?php echo lang('api_key'); ?>" id="field_4_1" class="form-control">
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            <label><?php echo lang('sender_id'); ?> <span class="required_star">*</span></label>
                            <input type="text" name="field_4_2" value="<?=(isset($sms_info->field_4_2) && $sms_info->field_4_2 ? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_4_2) : set_value('field_4_2'))?>" onfocus="select();" placeholder="<?php echo lang('sender_id'); ?>" id="field_4_2" class="form-control">
                        </div>
                ...
                <div class="row div_hide div_5" data-provider="5" style="<?php echo $active_provider === '5' ? '' : 'display:none;'; ?>">
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            <label>API Token <span class="required_star">*</span></label>
                            <input type="text" name="field_5_0" value="<?=(isset($sms_info->field_5_0) && $sms_info->field_5_0 ? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_5_0) : set_value('field_5_0'))?>" onfocus="select();" placeholder="API Token" class="form-control">
                        </div>
                        <?php if (form_error('field_5_0')) { ?>
                            <div class="callout callout-danger my-2">
                                <?php echo form_error('field_5_0'); ?>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            <label><?php echo lang('sender_id'); ?> <span class="required_star">*</span></label>
                            <input type="text" name="field_5_1" value="<?=(isset($sms_info->field_5_1) && $sms_info->field_5_1 ? (APPLICATION_MODE == "demo" ? 'XXXXXXXXXXXXXXXXXXXX' : $sms_info->field_5_1) : set_value('field_5_1'))?>" onfocus="select();" placeholder="<?php echo lang('sender_id'); ?>" class="form-control">
                        </div>
                        <?php if (form_error('field_5_1')) { ?>
                            <div class="callout callout-danger my-2">
                                <?php echo form_error('field_5_1'); ?>
                            </div>
                        <?php } ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" name="sms_enable_status">
                                <option value="1" <?php echo escape_output($sms_information->sms_enable_status) == 1 ? 'selected' : '' ?>><?php echo lang('Enable'); ?></option>
                                <option value="2" <?php echo escape_output($sms_information->sms_enable_status) == 2 ? 'selected' : '' ?>><?php echo lang('Disable'); ?></option>
                            </select>
                        </div>
                        <?php if (form_error('sms_enable_status')) { ?>
                            <div class="callout callout-danger my-2">
                                <?php echo form_error('sms_enable_status'); ?>
                            </div>
                        <?php } ?>
                    </div>
                </div>
                ...
                <?php foreach ($sms_status_options as $code => $label): 
                    $template = isset($status_templates[$code]) ? $status_templates[$code] : ['enabled' => 0, 'message' => ''];
                ?>
                <div class="row mb-3 align-items-center">
                    <div class="col-md-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="status_templates[<?= $code ?>][enabled]" id="status_<?= $code ?>" value="1" <?php echo $template['enabled'] ? 'checked' : '';?>>
                            <label class="form-check-label" for="status_<?= $code ?>">
                                <?= escape_output($label) ?>
                            </label>
                        </div>
                    </div>
                    <div class="col-md-10">
                        <textarea class="form-control" name="status_templates[<?= $code ?>][message]" rows="2" placeholder="আপনার মেসেজ লিখুন"><?= escape_output($template['message']) ?></textarea>
                         মেসেজ শর্ট কোডঃ {{customer_name}}, {{sale_no}}, {{amount}}, {{total_amount}}, {{paid_amount}}, {{due_amount}}, {{account_type}}
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
...
<script>
    // Clipboard copy helpers intentionally removed so the shortcodes stay static.
</script>
