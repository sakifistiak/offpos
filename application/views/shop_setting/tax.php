<script src="<?php echo base_url(); ?>frequent_changing/js/tax.js"></script>
<!-- Main content -->
...
<h3 class="display_none">&nbsp;</h3>
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('Tax_Setting'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('Tax_Setting'), 'secondSection'=> lang('Tax_Setting')])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        <div class="table-box">
            ...
            ?>
            <?php echo form_open(base_url() . 'Tax_setting/tax/'.(isset($company) && $company->id?$company->id:''), $arrayName = array('id' => 'update_tax_setting','enctype'=>'multipart/form-data')) ?>
            <div class="box-body">
                <div class="row">
                ...
                <div id="tax_yes_section" class="<?php echo escape_output($company->collect_tax) == 'Yes' ? 'd-block' : 'd-none' ?>">
                    <div class="row">
                        <div class="col-12">
                            <button id="show_sample_invoice_with_tax" type="button" class="btn bg-blue-btn" data-bs-toggle="modal" data-bs-target="#show_sample_invoice_with_tax_modal"><?php echo lang('show_invoice_sample'); ?></button>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input  type="text" id="tax_title" name="tax_title" class="form-control" placeholder="<?php echo lang('my_tax_title'); ?>" value="<?php echo escape_output($company->tax_title); ?>">
                            </div>
                            ...
                            <div class="alert alert-error txt_35 txt_11 display-none" id="tax_title_error">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input  type="text" id="tax_registration_no" name="tax_registration_no" class="form-control" placeholder="<?php echo lang('tax_registration_no'); ?>" value="<?php echo escape_output($company->tax_registration_no); ?>">
                            </div>
                            ...
                            <div class="alert alert-error txt_35 txt_11 display-none" id="tax_registration_no_error">
                                ...
                                <table id="datatable" class="table table-bordered table-striped">
                                    ...
                                    if(isset($tax_setting) && count($tax_setting)>0){
                                        foreach($tax_setting as $key=>$single_tax){
                                            ...
                                            $show_tax_row .= '<td><input type="hidden" name="p_tax_id[]" value="'.(isset($single_tax->id) && $single_tax->id?$single_tax->id:'').'"><input type="text" name="taxes[]" '.setReadonly(1,$single_tax->tax).' class="form-control check_required m-0" value="'.$single_tax->tax.'"></td>';
                                            $show_tax_row .= '<td><input type="text" onfocus="select()" name="tax_rate[]" class="form-control integerchk check_required m-0" value="'.$single_tax->tax_rate.'"></td>';
                                            $show_tax_row .= '<td style="display: '.setReadonly(2,$single_tax->tax).';"><button type="button" class="remove_this_tax_row txt_25 new-btn-danger h-40" id="remove_this_tax_row_'.$new_row_number.'" ><iconify-icon icon="solar:trash-bin-minimalistic-broken" width="18"></iconify-icon> </button></td>';
                                            $show_tax_row .= '</tr>';
                                            $new_row_number++;
                                        }
                                    }
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-center">
                    <img src="<?php echo base_url()?>uploads/site_settings/GST_Invoice.jpg" alt="gst_invoice_example">
                </p>
            </div>
