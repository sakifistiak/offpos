                    ...
                    <div class="col-md-6 col-lg-4 mb-3"> 
                        <div class="form-group">
                            ...
                            <select  class="form-control select2 op_width_100_p" name="employee_id">
                                ...
                                ?>
                                    <option <?php echo $logedin_user_id == $empls->id ? 'selected' : '' ?> value="<?php echo escape_output($empls->id) ?>" <?php echo set_select('employee_id', $empls->id); ?>><?php echo escape_output($empls->full_name) ?></option>
                                <?php } ?>
                            </select>
                        </div>
