...
<body>
    <div id="wrapper" class="m-auto border-2s-e4e5ea br-5 p-15">
        ...
        <div class="text-center">
            <?php if($inv_config->qr_code_business == 'Yes'){?>
                <h3 class="font-size-20"><?php echo escape_output($company_info->business_name); ?></h3>
            <?php } ?>

            <?php if($inv_config->qr_code_outlet == 'Yes'){?>
            <h4 class="pb-7 font-size-15"><?php echo escape_output($outlet_info->outlet_name); ?></h4>
            <?php if($inv_config->qr_code_address == 'Yes'){?>
            ...
            <?php if($this->session->userdata('collect_tax') == 'Yes' && $inv_config->qr_code_taxnumber == 'Yes'){ ?>
        ...
        <div>
            ...
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <?php if($inv_config->qr_code_customer_name == 'Yes'){?>
                ...
                <div class="text-rigth">
                    ...
                    <?php if($inv_config->qr_code_invoice_no == 'Yes'){?>
                    <p class="f-w-500 color-71 font-size-13">
                        <span class="f-w-600">
                        <?php 
                            if($s_status == 'Bangladesh'){
                    ...
                    <?php if($inv_config->qr_code_invoice_date_time == 'Yes'){?>
                    <p class="f-w-500 color-71 font-size-13"> 
                        <span class="f-w-600">
                            <?php 
                            if($s_status == 'Bangladesh'){
                    ...
                    if (isset($sale_object->items)) :
                        ...
                        ?>
                            <tr>
                                ...
                                <p class="text-muted short_note">
                                    <?php echo lang('will_expire');?> <?= date($company_info->date_format, strtotime(dateMonthYearFinder($row->warranty, $warranty_date, $sale_object->sale_date))) ?>
                                </p>
                                <?php } ?>
                                <?php 
                                $guarantee_date = '';
                                ...
                                <p class="text-muted short_note">
                                    <?php echo lang('will_expire');?> <?= date($company_info->date_format, strtotime(dateMonthYearFinder($row->guarantee, $guarantee_date, $sale_object->sale_date))) ?>
                                </p>
                                <?php } ?>
        ...
        <div class="">
            <div>
                ...
                <?php if($inv_config->qr_code_subtotal == 'Yes'){?>
                <?php
                ...
                <?php if($inv_config->qr_code_tax == 'Yes'){?>
                <?php if($tax) {
                    $i = 0;
                    foreach($tax as $t){ 
                ...
                <?php if($inv_config->qr_code_charge == 'Yes'){?>
                ...
                <?php if($inv_config->qr_code_total_payable == 'Yes'){?>
                <?php
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <p class="font-size-13"><?php echo getAmtCustom($ln_text=="bangla"?banglaNumber($sale_object->change_amount):$sale_object->change_amount) ?></p>
                </div>
                <?php }  ?>
        ...
        <div class="mt-30">
            <p><?php echo $company_info->term_conditions; ?></p>
        </div>
        
        <div class="d-flex justify-content-center pt-30">
            <div>
                <p class="font-size-15"><?php echo $company_info->invoice_footer; ?></p>
            </div>
        </div>
