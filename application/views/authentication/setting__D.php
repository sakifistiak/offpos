            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-4 col-lg-4 col-xl-3">
                        <div class="nav flex-column nav-pills me-3 custom_nav_pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Business Setting</button>
                            <button class="nav-link" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">POS Setting</button>
                            <button class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">Invoice Setting</button>
                            <button class="nav-link" id="v-pills-items-tab" data-bs-toggle="pill" data-bs-target="#v-pills-items" type="button" role="tab" aria-controls="v-pills-items" aria-selected="false">Items Setting</button>
                        </div>
                    </div>

                    <div class="col-md-8 col-lg-8 col-xl-9">
                        <div class="tab-content custom_nav_content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                <h3 class="mb-3 top-left-header">Business Setting</h3>
                                <div class="row">
                            ...
                            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                <h3 class="mb-3 top-left-header">POS Setting</h3>
                                <div class="row">
                                    <div class="col-md-6 col-lg-4 mb-3">
                                        <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                <h3 class="mb-3 top-left-header">Invoice Setting</h3>
                                <div class="row">
                                    <div class="col-md-6 col-lg-4 mb-3">
                                        <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="v-pills-items" role="tabpanel" aria-labelledby="v-pills-items-tab">
                                <h3 class="mb-3 top-left-header">Item Setting</h3>
                                <div class="row">
                                    <div class="col-md-6 col-lg-4 mb-3">
                                        <div class="form-group">
                                            <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3 div_loyalty">
                                        <div class="form-group">
                                            <label>
