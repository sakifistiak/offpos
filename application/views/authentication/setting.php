                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 mb-3">
                        <div class="form-group">
                            <div class="d-flex justify-content-between align-items-center">
                                <label>
                                    <?php echo lang('E_Commerce_Enable_Status');?>
                                    <span class="required_star">*</span>
                                </label>
                            </div>
                            <select  class="form-control select2" name="e_commerce_checker"
                                id="e_commerce_checker">
                                <option value="Yes" <?=($outlet_information->e_commerce_checker== 'Yes' ? 'selected':'')?>><?php echo lang('yes'); ?></option>
                                <option value="No" <?=($outlet_information->e_commerce_checker== 'No' ? 'selected':'')?>><?php echo lang('no'); ?></option>
                            </select>
                        </div>
                        <?php if (form_error('e_commerce_checker')) { ?>
                        <div class="callout callout-danger my-2">
                            <?php echo form_error('e_commerce_checker'); ?>
                        </div>
                        <?php } ?>
                    </div>
