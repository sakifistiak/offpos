...
<?php
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('edit_promotion'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('promotion'), 'secondSection'=> lang('edit_promotion')])?>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-sm-12 mb-3 col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 type" name="type" id="type">
                                ...
                                <option value="3" <?php echo isset($promotion_details->type) && $promotion_details->type==3?'selected':''?> <?php echo set_select('type',3)?>><?php echo lang('discount_coupon_entire'); ?></option>
                        ...
                        <div class="form-group select_promotion">
                            ...
                            <select  class="form-control select2 " name="food_menu_id"
                                ...
                                foreach ($items as $value) {
                                    ?>
                                    <option <?php echo isset($promotion_details->food_menu_id) && $promotion_details->food_menu_id==$value->id?'selected':''?> <?php echo set_select('food_menu_id',$value->id)?> value="<?php echo escape_output($value->id) ?>">
                                    <?php 
                    ...
                    <div class="col-sm-12 mb-3 col-md-3 display_none coupon_code">
                        <div class="form-group">
                            ...
                            <input  type="text" name="coupon_code"  class="form-control"
                                    placeholder="<?php echo lang('coupon_code');?>" value="<?php echo escape_output($promotion_details->coupon_code)?>">
                        </div>
                    ...
                    <div class="col-sm-12 mb-3 col-md-3 discount_both">
                        <div class="form-group">
                            ...
                            <input  type="text" name="discount"  class="form-control"
                                   placeholder="<?php echo lang('discount_type');?>" value="<?php echo escape_output($promotion_details->discount)?>">
                        </div>
                    ...
                    <div class="col-sm-12 mb-3 col-md-3 display_none free_item_div">
                        <div class="form-group select_promotion">
                            ...
                            <select  class="form-control select2 " name="buy_food_menu_id"
                                ...
                                foreach ($items as $value) {
                                    ?>
                                    <option <?php echo isset($promotion_details->food_menu_id) && $promotion_details->food_menu_id==$value->id?'selected':''?> <?php echo set_select('buy_food_menu_id',$value->id)?> value="<?php echo escape_output($value->id) ?>">
                                    <?php 
                    ...
                    <div class="col-sm-12 mb-3 col-md-3 display_none free_item_div">
                        <div class="form-group">
                            ...
                            <input  type="text" name="qty" class="form-control aligning  integerchk"
                    ...
                    <div class="col-sm-12 mb-3 col-md-3 display_none free_item_div">
                        <div class="form-group select_promotion">
                            ...
                            <select  class="form-control select2 " name="get_food_menu_id"
                                ...
                                foreach ($items as $value) {
                                    ?>
                                    <option <?php echo isset($promotion_details->get_food_menu_id) && $promotion_details->get_food_menu_id==$value->id?'selected':''?> <?php echo set_select('get_food_menu_id',$value->id)?>  value="<?php echo escape_output($value->id) ?>">
                                    <?php 
                                    $string = ($value->parent_name != '' ? $value->parent_name . ' - ' : '') . ($value->name . ' - ' . $value->code) . ($value->brand_name != '' ? ' - ' . $value->brand_name : ''); 
                                    echo escape_output($string);
                                    ?>
