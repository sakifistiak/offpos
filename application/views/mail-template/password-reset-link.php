                                        ...
                                        <tr>
                                            <td align="left" style="padding-left: 20px;">
                                                <div class="welcome-container">
                                                    ...
                                                    <p class="welcome-to" style="font-style: normal;font-weight: 600;font-size: 16px;line-height: 120%;"></p>
                                                </div>
                                            </td>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" style="padding: 20px 20px 0px 20px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td align="middle">
                                        <h1 style="font-size: 28px; color: #121a26; margin: 0;">Reset Password!</h1>
                                    </td>
                                </tr>
                                <tr>
