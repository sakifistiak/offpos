                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                ...
                                <tr>
                                    <td align="left" style="padding: 10px 0;">
                                        ...
                                        <a style="background: #1b3056;color: white; padding: 10px; border-radius: 4px; font-size: 15px; font-weight:600;text-decoration: none;" href="<?php echo base_url();?>payment-now/<?php echo $this->custom->encrypt_decrypt($pay_com_id, 'encrypt') ?>">Payment Now</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
