...
<h3 class="display_none">&nbsp;</h3>
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('salary_payroll'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('salary'), 'secondSection'=> lang('salary_payroll')])?>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-12"><br>
                    <div class="form-group">
                        <h3  class="top-left-header txt-uh-82"><?php echo lang('salary_sheet_for'); ?>: <?php echo escape_output($month)?> - <?php echo escape_output($year)?></h3>
                    </div>
                </div>
            </div>
            <!-- form start -->
                ...
                <table id="datatable" class="table table-bordered table-striped">
                    ...
                    foreach ($getSalaryUsers as $usrs) {
                            ...
                            <tr class="row_counter" data-id="<?php echo escape_output($usrs->id); ?>">
                                        ...
                                        <tr>
                                            <td class="text-start">  
                                                <label class="container"><?php echo lang('select'); ?>
                                                    ...
                                                    <span class="checkmark"></span>
                                                    <input type="hidden" name="generated_salary[]" class="generated_salary">
                                                </label>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td>
                                    <?php echo escape_output($usrs->full_name); ?>
                                    <input type="hidden" name="user_id[]" value="<?php echo escape_output($usrs->id); ?>">
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" placeholder="<?php echo lang('salary_amount'); ?>" class="form-control"  id="salary_<?php echo escape_output($usrs->id); ?>" name="salary[]" value="<?php echo isset($usrs->salary) && $usrs->salary ? getAmtPre($usrs->salary) : getAmtPre(0) ?>" readonly>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" placeholder="<?php echo lang('additional'); ?>" class="form-control cal_row integerchk" onfocus="select();" id="additional_<?php echo escape_output($usrs->id); ?>"  name="additional[]" value="">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" placeholder="<?php echo lang('subtraction'); ?>" class="form-control cal_row integerchk" onfocus="select();" id="subtraction_<?php echo escape_output($usrs->id); ?>"  name="subtraction[]" value="">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" placeholder="<?php echo lang('total'); ?>" class="form-control" readonly id="total_<?php echo escape_output($usrs->id); ?>"  name="total[]" value="">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" placeholder="<?php echo lang('note'); ?>" class="form-control"  name="notes[]" value="">
                                    </div>
                                </td>
                            </tr>
                            <?php
