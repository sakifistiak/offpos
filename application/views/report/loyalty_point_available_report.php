...
<section class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('available_loyalty_point_report') ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('report'), 'secondSection'=> lang('available_loyalty_point_report')])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        ...
        <div class="report_header">
            ...
            <?php } ?>
            <h5 class="outlet_info">
                <?php if(isset($customers_dropdown) && $customer_id){ ?>
        ...
        <div class="table-box">
            <div class="table-responsive">
                <input type="hidden" class="datatable_name"  data-filter="yes" data-title="<?php echo lang('available_loyalty_point_report'); ?>" data-id_name="datatable">
