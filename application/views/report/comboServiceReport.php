...
<div class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('combo_service_report'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('report'), 'secondSection'=> lang('combo_service_report')])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        ...
        <div class="report_header">
            ...
            <h5 class="outlet_info">
                <strong><?php echo lang('combo_service_report'); ?></strong>
            </h5>
                ...
                <table id="datatable" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo lang('items'); ?> (<?php echo lang('code');?>)</th>
                    ...
                    <tbody>
                        <?php
                        $totalSum = 0;
                        if (isset($comboServiceReport)):
                            foreach ($comboServiceReport as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo dateFormat($value->date_time) ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="mt-3">
                                            <?php 
                                                $combo_items = getComboItemsBySaleDetailsId($value->id);
                                                // pre($combo_items);
                                                echo "<strong>Name(Code)-Qty-Unit Price-Subtotal</strong>" . "<br>";
                                                foreach($combo_items as $combo){
                                                    echo escape_output($combo->item_name) . '(' . $combo->code . ')-' . $combo->combo_item_qty . $combo->unit_name . '-' . getAmtCustom($combo->combo_item_price) . '-' . getAmtCustom($combo->combo_item_qty * $combo->combo_item_price) . '<br>'; 
                                                }
                                            ?>
...
<div id="product-filter" class="filter-modal">
    <div class="filter-modal-body">
        ...
        <?php echo form_open(base_url() . 'Report/comboServiceReport', $arrayName = array('id' => 'saleReport')) ?>
        <div class="row">
