...
<div class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('due_sale_report'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('report'), 'secondSection'=> lang('due_sale_report')])?>
        </div>
    </section>
            ...
            <input type="hidden" class="datatable_name"  data-filter="yes" data-title="<?php echo lang('food_sales_report'); ?>" data-id_name="datatable">
                <table id="datatable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $chargeTotal = 0;
                        $totalTax = 0;
                        if (isset($dueSaleReport)):
                            foreach ($dueSaleReport as $key => $value) {
                                $key++;
...
<div id="product-filter" class="filter-modal">
    <div class="filter-modal-body">
        ...
        <?php echo form_open(base_url() . 'Report/dueSaleReport', $arrayName = array('id' => 'saleReport')) ?>
        <div class="row">
