...
<div class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('price_history_report'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('report'), 'secondSection'=> lang('price_history_report')])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        ...
        <div class="report_header">
            ...
            <h5 class="outlet_info">
                <strong><?php echo lang('price_history_report'); ?></strong>
            </h5>
            ...
            <h5 class="outlet_info">
                <?php if(isset($item_id) && $item_id){ ?>
                    <strong><?php echo lang('item'); ?>: </strong> <?= getItemParentAndChildNameCode($item_id); ?>
                <?php } ?>
            </h5>
            <h5 class="outlet_info">
        ...
        <div class="table-box">
            <div class="table-responsive">
                <input type="hidden" class="datatable_name"  data-filter="yes" data-title="<?php echo lang('Item_Tracing'); ?>" data-id_name="datatable">
                <table id="datatable" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="w-15 text-center"><?php echo lang('item_price'); ?></th>
                            <th class="w-15"><?php echo lang('outlet_name'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if(isset($priceHistory) && $priceHistory){
                        foreach($priceHistory as $key=>$item){ 
                        ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo getAmtCustom($item->item_price);?></td>
...
<div id="product-filter" class="filter-modal">
    <div class="filter-modal-body">
        ...
        <?php echo form_open(base_url() . 'Report/priceHistory') ?>
        <div class="row">
            ...
            <div class="col-12 mb-2">
                <button type="submit" name="submit" value="submit" class="new-btn priceHistory">
