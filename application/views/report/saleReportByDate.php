...
<div class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('daily_sale_report'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('report'), 'secondSection'=> lang('daily_sale_report')])?>
        </div>
    </section>
    ...
    <div class="box-wrapper"> 
        ...
        <div class="report_header">
            ...
            <h5 class="outlet_info">
                <strong><?php echo lang('daily_sale_report'); ?></strong>
            &nbsp;</h5>
            ...
            <h5 class="outlet_info">
                <?php if(isset($user_id) && $user_id){ ?>
                    <strong><?php echo lang('employee'); ?>: </strong> <?php echo userName($user_id); ?>
                <?php }else{ ?>
        ...
        <div class="table-box"> 
            <div class="table-responsive">
                <div class="box-body">
                <input type="hidden" class="datatable_name"  data-filter="yes" data-title="<?php echo lang('daily_sale_report'); ?>" data-id_name="datatable">
                    <table id="datatable" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang('down_payment'); ?></th>
                                <th><?php echo lang('installment_collection_amount'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            if (isset($saleReportByDate)):
                                foreach ($saleReportByDate as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo getDownPaymentByDate($value->sale_date,$value->sale_date,$value->user_id, $value->outlet_id)?></td>
                                        <td><?php echo getCollectionInstallmentByDate($value->sale_date,$value->sale_date,$value->user_id, $value->outlet_id)?></td>
                                    </tr>
                                    <?php
                                }
                            endif;
                            ...
                            <tr>
                                ...
                                <th><?php echo getAmtCustom($grandTotal) ?></th>
                                <th class="op_right"></th>
                                <th class="op_right"></th>
                            </tr>
                        </tbody>
                    </table>
