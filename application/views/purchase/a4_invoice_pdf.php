        ...
        <table>
            <tr>
                <td class="w-50">
                    ...
                    <p class="pb-7 f-w-900 rgb-71 common-heading"><?php echo escape_output($outlet_info->outlet_name); ?></p>
        ...
        <table>
            <tr>
                <td valign="top" class="w-33">
                    <h3 class="pb-7"><?php echo lang('purchase_info');?></h3>
                ...
                <td class="w-48">
                    ...
                    <table>
                        <tr>
                            <td class="w-50">
                                <p class="f-w-600">
                                <?php echo escape_output($pay_method->payment_method_name); ?>
                                </p>
                            </td>
                            <td class="w-50 text-right">
