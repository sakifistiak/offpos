...
<div class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <?php 
                if(isset($faq)){
                    $language = lang('edit') . ' ' .lang('faq');
                }else{
                    $language = lang('add') . ' ' .lang('faq');
                }
                ?>
                <h3 class="top-left-header mt-2"><?php echo $language ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('faq'), 'secondSection'=> $language])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        <div class="table-box"> 
            <!-- form start -->
            <?php echo form_open(base_url('ECommerce_setting/addEditFaq/' . (isset($faq) ? $this->custom->encrypt_decrypt($faq->id, 'encrypt') : ''))); ?>
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6 col-lg-4 mb-3">
                        <div class="form-group">
                            <label><?php echo lang('title'); ?></label>
                            <input  autocomplete="off" type="text" name="title" class="form-control" placeholder="<?php echo lang('title'); ?>" value="<?= isset($faq) && $faq ? $faq->title : set_value('title') ?>">
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-3">
                        <div class="form-group">
                            ...
                            <input  autocomplete="off" type="text" name="description" class="form-control" placeholder="<?php echo lang('description'); ?>" value="<?= isset($faq) && $faq ? $faq->description : set_value('description') ?>">
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-3">
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control select2">
                                <option <?= isset($faq) && $faq ? ($faq->status == 'Enable' ? 'selected' : '') : '' ?> value="Enable"><?php echo lang('enable');?></option>
                                <option <?= isset($faq) && $faq ? ($faq->status == 'Disable' ? 'selected' : '') : '' ?> value="Disable"><?php echo lang('disable');?></option>
                            </select>
                        </div>
            ...
            <div class="box-footer">
                ...
                <a class="btn bg-blue-btn text-decoration-none" href="<?php echo base_url() ?>ECommerce_setting/listFaq">
