...
class Income extends Cl_Controller {
    ...
    public function incomes() {
        ...
        if (htmlspecialcharscustom($this->input->post('submit'))) {
            ...
            $data['incomes'] = $this->Common_model->getAllIncomeOrExpenseByUserAndOutlet("tbl_incomes", $outlet_id, $start_date, $end_date, $user_id);
        } else {
            $data['incomes'] = $this->Common_model->getAllIncomeOrExpenseByUserAndOutlet("tbl_incomes", $outlet_id, '', '', '');
        }
