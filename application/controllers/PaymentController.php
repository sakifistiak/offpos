...
class PaymentController extends CI_Controller
{
    ...
    public function paymentStatus()
    {
        ...
        if($msg=="payment_failed"){
            ...
            // $txt = 'Congratulations, "'.$business.'" restaurant sign-up has been successful.
            //                 For active your account- <a href="'.base_url().'authentication/active_company/'.$companies_info->active_code.'">Active Now</a>';
            // $smtp =  getCompanySMTPAndStatus($company->id);
            // if($smtp){
            //     $emailSetting = json_decode($smtp->email_settings);
            //     if($emailSetting->enable_status == 1){
            //         $mail_data = [];
            //         $mail_data['to'] = ["$restaurantAdminUser->email_address"];
            ...
            //         $mail_data['user_name'] = $restaurantAdminUser->full_name;
