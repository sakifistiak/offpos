...
class Banglaconverter{
    ...
    var $num_to_bn_decimal = array('0'=>'শূন্য ','00'=>'শূন্য শূন্য ','1'=>'এক ','2'=>'দুই ','3'=>'তিন ','4'=>'চার ','5'=>'পাঁচ ','6'=>'ছয় ','7'=>'সাত ','8'=>'আট ', '9'=>'নয় ');
    var $hundred = 'শত';
    var $thousand = 'হাজার';
    var $lakh = 'লক্ষ';
    var $crore = 'কোটি';
    ...
    public function numToWord($number){
        ...
        $dot_tmp = explode(".", $number);
        if(isset($dot_tmp[1]) && ((int)$dot_tmp[1])){
            $dot = explode(".", $number);
            return $this->numberSelector($dot[0]).' দশমিক '.$this->numToBnDecimal($dot[1]);
        }else{
            return $this->numberSelector((int)$number);
        }
    }
