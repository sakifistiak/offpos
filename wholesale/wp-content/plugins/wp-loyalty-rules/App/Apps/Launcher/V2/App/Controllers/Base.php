...
class Base
{
    ...
    public function launcherWidgetData()
    {
        ...
        $settings['labels'] = array(
            'footer' => array(
                "powered_by" => __("", 'wp-loyalty-rules'),
                "title" => __("", "wp-loyalty-rules"),
            ),
            'reward_text' => __("পয়েন্ট দেখুন", 'wp-loyalty-rules'),
            'coupon_text' => __("আমার ভাউসার", 'wp-loyalty-rules'),
            'loading_text' => __("লোডিং", 'wp-loyalty-rules'),
            'loading_timer_text' => __("যদি ভাউসার অ্যাড না হয় ", 'wp-loyalty-rules'),
        );
    ...
    function getLauncherButtonContentData($is_admin_side = false)
    {
        $text_data = array(
            'launcher' => array(
                'appearance' => array(
                    'text' => self::$settings->opt('launcher.appearance.text', 'পয়েন্ট দেখুন', 'launcher_button'),
                    'icon' => array(
