...
class Update
{
    ...
    public function __construct($_api_url, $_plugin_file, $_api_data = null)
    {
         ...
         *
         */
        do_action('post_Updater_setup', $edd_plugin_data);
    ...
    private function get_version_from_remote()
    {
         ...
         */
        $api_params = apply_filters('Updater_api_params', $api_params, $this->api_data, $this->plugin_file);
    ...
    public function show_update_notification($file, $plugin)
    {
        ...
        /* translators: the plugin name. */
            esc_html__('There is a new version of %1$s available.', 'wp-loyalty-rules'),
        ...
        if (empty($update_cache->response[$this->name]->package) && !empty($changelog_link)) {
            ...
            /* translators: 1. opening anchor tag, do not translate 2. the new plugin version 3. closing anchor tag, do not translate. */
                esc_html(__(' %1$sView version %2$s details%3$s.', 'wp-loyalty-rules')),
            ...
            /* translators: 1. opening anchor tag, do not translate 2. the new plugin version 3. closing anchor tag, do not translate 4. opening anchor tag, do not translate 5. closing anchor tag, do not translate. */
                esc_html(__(' %1$sView version %2$s details%3$s or %4$supdate now%5$s.', 'wp-loyalty-rules')),
                '<a target="_blank" class="thickbox open-plugin-details-modal" href="' . esc_url($changelog_link) . '">',
                esc_html($update_cache->response[$this->name]->new_version),
                '</a>',
            ...
            printf(
                ' %1$s%2$s%3$s',
                '<a target="_blank" class="update-link" href="' . esc_url(wp_nonce_url($update_link, 'upgrade-plugin_' . $file)) . '">',
                esc_html__('Update now.', 'wp-loyalty-rules'),
                '</a>'
            );
        }
    ...
    public function show_changelog()
    {
        ...
        if (!current_user_can('update_plugins')) {
            wp_die(esc_html__('You do not have permission to install plugin updates', 'wp-loyalty-rules'), esc_html__('Error', 'wp-loyalty-rules'), array('response' => 403));
        }
