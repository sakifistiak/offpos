...
defined('WLR_PLUGIN_VERSION') or define('WLR_PLUGIN_VERSION', '1.2.8');
...
//defined plugin name
defined('WLR_PLUGIN_NAME') or define('WLR_PLUGIN_NAME', 'WPLoyalty - WooCommerce Loyalty Points, Rewards and Referral Pro');
