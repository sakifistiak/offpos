...
function FCPFW_loadAdminScriptStyle() {
  	...
  	wp_localize_script( 'FCPFW-admin-script', 'ajax_postajax', 
  		array( 
  			'ajaxurl' => admin_url( 'admin-ajax.php' ),
  			'ajaxnonce' => wp_create_nonce( 'fcpfw_ajax_nonce' )
  		) 
  	);
...
function FCPFW_loadScriptStyle() {
	...
	wp_localize_script( 'FCPFW-front_js', 'ajax_postajax', 
		array( 
			'ajaxurl' => admin_url( 'admin-ajax.php' ),
			'ajaxnonce' => wp_create_nonce( 'fcpfw_ajax_nonce' )
		) 
  ...
  wp_enqueue_script( 'jquery-effects-core' );
	...
	wp_localize_script('FCPFW-front_js', 'fcpfw_sidebar_width', array(
	  ...
	  'fcpfw_auto_open' => $fcpfw_comman['fcpfw_auto_open'],
		'fcpfw_auto_close' => $fcpfw_comman['fcpfw_auto_close'],
