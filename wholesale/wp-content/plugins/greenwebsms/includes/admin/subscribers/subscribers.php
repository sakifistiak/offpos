<div class="wrap">
    ...
    <div class="wpsms-button-group">
        <a name="<?php _e( 'Add Subscribe', 'wp-sms' ); ?>" href="admin.php?page=greenweb-sms-subscribers#TB_inline?&width=400&height=250&inlineId=add-subscriber" class="thickbox button"><span class="dashicons dashicons-admin-users"></span> <?php _e( 'Add Subscribe', 'wp-sms' ); ?>
        </a>
        <a href="admin.php?page=greenweb-sms-subscribers-group" class="button"><span class="dashicons dashicons-category"></span> <?php _e( 'Manage Group', 'wp-sms' ); ?>
        </a>
        <a name="<?php _e( 'Import', 'wp-sms' ); ?>" href="admin.php?page=greenweb-sms-subscribers#TB_inline?&width=400&height=270&inlineId=import-subscriber" class="thickbox button"><span class="dashicons dashicons-undo"></span> <?php _e( 'Import', 'wp-sms' ); ?>
        </a>
        <a name="<?php _e( 'Export', 'wp-sms' ); ?>" href="admin.php?page=greenweb-sms-subscribers#TB_inline?&width=400&height=150&inlineId=export-subscriber" class="thickbox button"><span class="dashicons dashicons-redo"></span> <?php _e( 'Export', 'wp-sms' ); ?>
        </a>
    </div>
				...
				<?php else: ?>
                    <tr>
                        <td>
	                        ...
	                        <?php echo sprintf( __( 'There is no group! <a href="%s">Add</a>', 'wp-sms' ), 'admin.php?page=greenweb-sms-subscribers-group' ); ?>
                        </td>
                    </tr>
				<?php endif; ?>
            ...
            <table>
                <tr>
                    <td style="padding-top: 10px;">
                        ...
                        <p class="upload-html-bypass"><?php echo sprintf( __( '<code>Excel 97-2003 Workbook (*.xls)</code> is the only acceptable format. Please see <a href="%s">this image</a> to show a standard xls import file.', 'wp-sms' ), plugins_url( 'greenwebsms/assets/images/standard-xml-file.png' ) ); ?></p>
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <div id="export-subscriber" style="display:none;">
        <form action="<?php echo plugins_url( 'greenwebsms/includes/admin/export.php' ); ?>" method="post">
            <table>
                <tr>
                    <td style="padding-top: 10px;">
