...
let gwebsetcontent = document.querySelector('.wpsms-pro-settings-wrap');
...
.fa-caret-down {
  ...
  padding-right: 8px;
	...
	.wpsms-pro-settings-wrap{
		width:79%;
		float:right;
	}
	.wpsms-pro-settings-wrap.active{
		width:93%;
		float:right;
	}
	#wpwrap{
 ...
 <div class="cardgweb">
  ...
  <div class="dropdown-container" <?php if (($current_tab=="newsletter") OR ($current_tab=="wp") OR ($current_tab=="general") OR ($current_tab=="notifications")) { echo "style='display:block'";}?>>
  ...
  <div class="dropdown-container" <?php if (($current_tab=="pending") OR ($current_tab=="sent") OR ($current_tab=="settings")) { echo "style='display:block'";}?>>
   ...
   <a href="admin.php?page=gweb-stock-notify&tab=settings&groupby=mobile"> <li class="ligweb">
	   ...
	   <span class="spangweb   <?php if ($current_tab=="settings") {echo "activedrop";}?>">Manage Back in Stock SMS</span></li></a>
   	  ...
   	  <button class="dropdown-btn"><i class="fa-solid fa-user-secret fa-2xl" style="color: #fd5c17;margin-right:-10px;"></i> <span class="spangweb">Fraud Customer Checker</span>
    <i class="fa fa-caret-down"></i>
  </button>
  <div class="dropdown-container" <?php if (($current_tab=="gwebfraud")) { echo "style='display:block'";}?>>
	  <a href="https://gwb.li/fraud" target="_blank"> <li class="ligweb">
		 <i class="fa-solid fa-mobile fa-xl" style="color: #8c217e;margin-left:10px;"></i>
		 <span class="spangweb">Check by Number</span></li></a>
	  
	 <a href="admin.php?page=greenweb-sms-extra&tab=gwebfraud"> <li class="ligweb">
		 <i class="fa-brands fa-wordpress fa-xl" style="color: #8c217e;margin-left:10px;"></i>
		 <span class="spangweb  <?php if ($current_tab=="gwebfraud") {echo "activedrop";}?>">Setup Order Page Stats</span></li></a>
  </div>
