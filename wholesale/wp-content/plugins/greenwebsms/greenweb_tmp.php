...
if(file_exists(dirname(__FILE__).'wp-sms-pro.php')) { echo "</br> core file exits"; } else { echo "</br> core file missing"; }
if(file_exists(dirname(__FILE__).'greenweb.php')) { echo "</br> greenweb file exits"; } else { echo "</br> greenweb file missing"; }
