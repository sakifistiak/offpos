...
*
* @requires ./docs/frequent_changing/css/bootstrap.css
* @requires ./docs/frequent_changing/css/bootstrap-responsive.css
* @requires ./docs/frequent_changing/js/v1.9.1-jquery.js
* @requires ./docs/frequent_changing/js/bootstrap-tooltip.js
*
...
* <script src="v1.9.1-jquery.js"> </script>
